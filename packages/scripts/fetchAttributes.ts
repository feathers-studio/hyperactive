...
export async function* fetchAttributes() {
	...
	const { "Global attribute": globalAttr, ...elements } = groupByList(
		[...document.querySelector("article table.standard-table tbody")!.childNodes]
			...
			.map(([attr, elems, description]) => {
				...
				const [propElement, isExpElement] = attr.childNodes;

				if (!isElement(propElement)) throw new Error("Expected prop element");
				if (!isElement(isExpElement)) throw new Error("Expected experimental element");
	...
	yield "// This file was generated by hypertyper. Do not manually edit this file.\n";
