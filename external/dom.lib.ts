...
export interface ConfirmSiteSpecificExceptionsInformation
...
export interface PaymentMethodChangeEventInit
...
export interface SpeechSynthesisErrorEventInit
...
export interface StoreSiteSpecificExceptionsInformation
...
export interface PaymentResponseEventMap {
...
export interface ProgressEvent<T extends EventTarget = EventTarget>
	extends Event {
