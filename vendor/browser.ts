...
Copyright (c) Feathers Studio 2022
Licensed under the MIT License
***************************************************************************** */

/**
 * The purpose of vendoring this module from remix-run/history is to remove
 * global types, and slim down the package to only browser history.
 *
 * This may be the right move for now, and is subject to be re-evaluated later.
 */
import type { BeforeUnloadEvent, Document, Window } from "../vendor/dom.slim.ts";
